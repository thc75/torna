...
public class DocInfoDetailCreateParam {
    ...
    @ApiDocField(description = "请求头", elementClass = HeaderParamCreateParam.class)
    private List<HeaderParamCreateParam> headerParams;

    @ApiDocField(description = "请求参数", elementClass = DocParamCreateParam.class)
    private List<DocParamCreateParam> requestParams;

    @ApiDocField(description = "返回参数", elementClass = DocParamCreateParam.class)
    private List<DocParamCreateParam> responseParams;

    @ApiDocField(description = "错误码", elementClass = CodeParamCreateParam.class)
