 ...
 * @author tanghc
 */
public class DocPushOverrideTest extends BaseTest {
    ...
    public void testDocPush() {
        ...
        // 只改变第一个文档，不影响其它文档
        DocItem docItem = buildDocItem(0);
        items.add(docItem);
        // 创建调试环境
...
//            enumItemParam.setSolution("解决方案" + i);
    ...
    private static DocItem buildDocItem(int i) {
        ...
        item.setAuthor("王五111");
        /* 设置基本信息 */
        item.setName("获取商品名称" + i);
        item.setDescription("这里是描述信息111..." + i);
        ...
        queryCreateParamReq.setName("uid11");
        ...
        paramCreateParamReq.setName("goodsName11");
        ...
        paramCreateParamReq2.setName("priceList11");
        ...
        // id参数
        paramCreateParamResp.setName("id11");
        ...
        paramCreateParamResp2.setName("type11");
    ...
    private static List<DocParamReq> buildChildren() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            paramCreateParamReq2_child.setName("price11" + i);
            paramCreateParamReq2_child.setType("int");
            paramCreateParamReq2_child.setDescription("价格11");
