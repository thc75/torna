...
```bash
wget https://gitee.com/durcframework/torna/raw/master/install/restart-torna.sh && sh restart-torna.sh 1.19.3
```
...
`docker pull tanghc2020/torna:1.19.3`
