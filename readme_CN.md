...
```bash
wget https://gitee.com/durcframework/torna/raw/master/install/restart-torna.sh && sh restart-torna.sh 1.31.0
``` 
...
`docker pull registry.cn-hangzhou.aliyuncs.com/tanghc/torna:1.31.0`
...
docker run --name torna --restart=always \
  ...
  -d registry.cn-hangzhou.aliyuncs.com/tanghc/torna:1.31.0
```
