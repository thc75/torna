...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COMMENT='文档信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=271 DEFAULT CHARSET=utf8mb4 COMMENT='文档参数';
...
INSERT INTO `doc_info` (`id`, `data_id`, `name`, `description`, `author`, `type`, `url`, `http_method`, `content_type`, `is_folder`, `parent_id`, `module_id`, `is_use_global_headers`, `is_use_global_params`, `is_use_global_returns`, `is_request_array`, `is_response_array`, `request_array_type`, `response_array_type`, `create_mode`, `modify_mode`, `creator_id`, `creator_name`, `modifier_id`, `modifier_name`, `order_index`, `remark`, `is_show`, `is_deleted`, `gmt_create`, `gmt_modified`) VALUES
	...
	(18,'c018597c3da062833820d46754d8d74f','订单模块','','',0,'','','',1,0,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:22','2021-06-08 13:54:22'),
	(19,'1d3c432b05bf4b7203ebace0bf044c1f','提交数组/返回数组5','List方式','',0,'/order/postArr5','POST','application/json',0,18,3,1,1,1,1,1,'integer','integer',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(20,'4b5436a9e81ac22371e0f7b6b00afb8c','提交数组/返回数组3','','',0,'/order/postArr3','POST','application/json',0,18,3,1,1,1,1,1,'object','integer',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(21,'2ced912c74e4eb9a53479413f39d4b19','提交数组/返回数组2','','',0,'/order/postArr2','POST','application/json',0,18,3,1,1,1,1,1,'integer','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(22,'b60a5a7e94a05644bf50254d9fdf6eab','提交数组/返回数组4','List方式','',0,'/order/postArr4','POST','application/json',0,18,3,1,1,1,1,1,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(23,'1d8483ef6bb80ccd79cf114d56461b05','提交数组/返回数组','','',0,'/order/postArr','POST','application/json',0,18,3,1,1,1,1,1,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(24,'0e36106f99a0adb4d4f3160c1c2ae6c3','演示query参数,不加@RequestParam','演示query参数,不加@RequestParam','',0,'/order/get','GET','',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(25,'1d0253f8f8fb2f3e2ae352dddfa5f2be','提交订单信息，application/json','提交订单信息，application/json','Tom',0,'/order/create','POST','application/json',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(26,'1081d1f598bcc0df2a48894a506212ae','全部参数form，全部由@ApiImplicitParams实现','全部由@ApiImplicitParams实现','',0,'/order/submit3/{productNo}','POST','application/x-www-form-urlencoded',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(27,'73e15ad9d976104a63ae2771dc5223d2','全部参数json，全部由@ApiImplicitParams实现','全部由@ApiImplicitParams实现','',0,'/order/submit2/{productNo}','POST','application/json',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(28,'874136230933126ceb9e164411ae059b','全部参数upload，全部由@ApiImplicitParams实现','全部由@ApiImplicitParams实现','',0,'/order/submit4/{productNo}','POST','multipart/form-data',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(29,'b9bdb068beda69e48579c7725a835030','提交订单信息，application/x-www-form-urlencoded','提交订单信息，application/x-www-form-urlencoded','',0,'/order/create2','POST','application/x-www-form-urlencoded',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(30,'e7b907533f53eb25306c649c2f3cc2f9','演示path参数','演示path参数','',0,'/order/get/{orderNo}','GET','',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(31,'b34e5dcb5db2e798861857ec008a9bc9','演示query参数,加@RequestParam','演示query参数,加@RequestParam','',0,'/order/get2','GET','',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(32,'52cf7d54d887867c18a229ab93fe4df1','演示path参数+query参数+body参数+header','提交订单信息说明。。','',0,'/order/submit/{productNo}','POST','application/json',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(33,'4fbc6d999497b96a284eff0f110e5fcb','获取某个产品下的订单','<strong>注意：</strong>html演示。。','',0,'/order/get/{productNo}','GET','',0,18,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(34,'16f0ece214cf202e41fe482494b0ebce','产品模块','','',0,'','','',1,0,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',-1,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(35,'1ab4dee15c5cb5f16205446f16e8ba01','返回树','','',0,'/product/getTree','GET','',0,34,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(36,'2146fa58a9dcdb3f7c52d350e9732a27','获取产品','获取产品说明。。','Tom,Jim',0,'/product/get/{productNo}','GET','',0,34,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',0,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(37,'d8fe88fd74144ac90b50d94bde7414ee','上传文件','','',0,'/product/upload','POST','multipart/form-data',0,34,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',11,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(38,'9edd7624130fe72727016b02df1e9d77','上传文件2','','',0,'/product/upload2','POST','multipart/form-data',0,34,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',12,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(39,'8bccd6dd861c2671738b56e179d8804d','上传文件3','','',0,'/product/upload3','POST','multipart/form-data',0,34,3,1,1,1,0,0,'object','object',1,1,2,'Jim',2,'Jim',13,'',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23');
...
INSERT INTO `doc_param` (`id`, `data_id`, `name`, `type`, `required`, `max_length`, `example`, `description`, `enum_id`, `doc_id`, `parent_id`, `style`, `create_mode`, `modify_mode`, `creator_id`, `creator_name`, `modifier_id`, `modifier_name`, `order_index`, `is_deleted`, `gmt_create`, `gmt_modified`) VALUES
	...
	(84,'a5b6cf48c787af0c5134e913be3d9430','','integer',0,'-','1,2,3','订单id',0,19,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(85,'f9af347c3f5ed5c3806cf599d3fbe451','','integer',0,'-','4,5,6','返回订单id',0,19,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(86,'d6d70fa7d4772f7ebc78202136e5bf68','orderNo','string',0,'-','aaaa','订单id',0,20,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(87,'d052a21bd76ba3ed86c5c9ac6bc1955c','remark','string',0,'-','订单','备注',0,20,0,2,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(88,'f7c14baf034ef3dd91bb5ef6313fe3e9','','integer',0,'-','1,2,3','订单id',0,20,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(89,'05d8e546708fef42108b7f635c7ec5dc','','integer',0,'-','1,2,3','订单id',0,21,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(90,'5f9026861a38004ef982d262742db7c1','orderNo','string',0,'-','aaaa','订单id',0,21,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(91,'e7f04c283b820db984a3ca6bd27993be','remark','string',0,'-','订单','备注',0,21,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(92,'6ef100c9aa2e124f83c5f801d85f796a','orderNo','string',0,'-','aaaa','订单id',0,22,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(93,'4e50d9fba9c00acaaf63c8c2ed886460','remark','string',0,'-','订单','备注',0,22,0,2,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(94,'6355281c7ff265f27fbeebc32ce42a01','orderNo','string',0,'-','aaaa','订单id',0,22,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(95,'4ad48afcca35dad0317a4fbbd7f9ac21','remark','string',0,'-','订单','备注',0,22,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(96,'0c4e2f79eb1e495953f3dfa0a4159f66','orderNo','string',0,'-','aaaa','订单id',0,23,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(97,'7add78ade786825bf96865a71562898f','remark','string',0,'-','订单','备注',0,23,0,2,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(98,'e90aa6c4c29198933369486e39984ec8','orderNo','string',0,'-','aaaa','订单id',0,23,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(99,'afc4724bc99d08b6250a809e1b1040a1','remark','string',0,'-','订单','备注',0,23,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(100,'7ea1604dd117d666c8c84670a7cf69c1','orderNo','String',0,'-','xxx','订单id',0,24,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(101,'091108ac8e8bb814395b016000a7e782','code','integer',0,'-','0','状态码，0：成功',0,24,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(102,'a978c803be3842a481df0332070a3d90','data','object',0,'','','数据',0,24,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(103,'77ef81567422ca97bc902a7b349115a5','userId','number',0,'-','123','用户id',0,24,102,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(104,'d37b4490cc780f62d3fad9fb1db38d67','orderNo','string',0,'-','xxx','订单号',0,24,102,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(105,'e649fc70bccec7d4f626bb686c73ea9d','payTime','date',0,'-','2021-05-24 19:59:51','订单id',0,24,102,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(106,'d21177825d839cebb97c81990e70fc8d','orderNo','string',0,'-','aaaa','订单id',0,25,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(107,'87affcf6288d27285a9050f5b3d002cc','remark','string',0,'-','订单','备注',0,25,0,2,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(108,'1a6b14f345d366d3af77eea2b55ebe1e','code','integer',0,'-','0','状态码，0：成功',0,25,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(109,'27ad96bbf6ec46b1ebbabb224a072171','data','object',0,'','','数据',0,25,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(110,'b3e7da61e988ee4c0dee9aaa6686fe07','orderNo','string',0,'-','aaaa','订单id',0,25,109,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(111,'70a57deae301407483abc9db8e93e502','remark','string',0,'-','订单','备注',0,25,109,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(112,'36460eff715e9a7a21e82625dc88837b','100001','String',0,'-','','id错误',0,25,0,4,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(113,'cefb9f0a1892401bae4be1e82dc9cd2c','100002','String',0,'-','','错误描述2',0,25,0,4,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(114,'0ff32e576117c67e72089874cb3881ed','100003','String',0,'-','','错误描述3',0,25,0,4,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(115,'e3bcac59c41eba2c6b20bc35df75ce3b','productNo','integer',1,'-','11','产品id',0,26,0,0,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(116,'812ab1c9b1aea48d2c66f3d1004b323b','token','String',1,'-','asdfe','token',0,26,0,1,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(117,'6114eff1c655e6cfaaba4b4becb87683','qid','string',1,'-','xx','查询id',0,26,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(118,'3d3efbc3c37dfad9e7dd888afe453b1b','id','integer',0,'-','123','id',0,26,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(119,'01c1470e7d40c141bc35b13f802c4f1c','orderNo','string',0,'-','aaaa','订单id',0,26,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(122,'20934eaeb137fe4d252b855ce54e8226','code','integer',0,'-','0','状态码，0：成功',0,26,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(123,'630e4eb3e3e14642a23ab7de50cc2c32','data','object',0,'-','','数据',0,26,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(124,'30bf99206592c3c5cda8e88cf07ed843','productNo','integer',1,'-','11','产品id',0,27,0,0,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(125,'1c47d4981f3794628413f9d2487070cd','token','String',1,'-','asdfe','token',0,27,0,1,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(126,'9e2c90b18330dbff3c6385fa91b291c6','qid','string',1,'-','xx','查询id',0,27,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(127,'411e79440592ce90e4f1c962d980c394','id','integer',0,'-','123','id',0,27,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(128,'493df97a0e7c4deeb10747cfcf90413b','orderNo','string',0,'-','aaaa','订单id',0,27,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(131,'80b140ca86e47d8ffdc2c2b76389e342','code','integer',0,'-','0','状态码，0：成功',0,27,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(132,'4829a5875f0615563a0f1690e0bdf8aa','data','object',0,'','','数据',0,27,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(133,'c0bd0b0494c82f80f8b5009e7c33b94e','orderNo','string',0,'-','aaaa','订单id',0,27,132,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(134,'073a7c8d6311158093f418612c60f79a','remark','string',0,'-','订单','备注',0,27,132,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(135,'40b407613393b5f780d7406094408dcf','orderDetail','object',0,'','','订单详情',0,27,132,3,1,1,2,'Jim',2,'Jim',2,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(136,'008d41e5fe3b99793b6c8b5cf11f4367','userId','number',0,'-','123','用户id',0,27,135,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(137,'18d2124e2ff8eb7db18fafa333b4862b','orderNo','string',0,'-','xxx','订单号',0,27,135,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(138,'238f52a609b6419e3efff0779bb42a60','payTime','date',0,'-','2021-05-24 19:59:51','订单id',0,27,135,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(139,'92abae892c22b8d8cda54d42fc4b317c','products','array',0,'','','产品详情',0,27,132,3,1,1,2,'Jim',2,'Jim',3,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(140,'ba3d41d86a0711cdc47b9422fbc326b8','productNo','string',0,'-','aaaa','产品id',0,27,139,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(141,'c44f35372e4b2b5f4c09c12eaf5acf71','remark','string',0,'-','小米','备注',0,27,139,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(142,'a2b600f413f8650bdefb138b6142f8b8','productDetailVO','object',0,'','','产品详情',0,27,139,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(143,'418edf852a19682a02deec259c264cca','productNo','string',0,'-','aaaa','产品id',0,27,142,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(144,'376a4476b37dd4b074c8af0db90a2c17','remark','string',0,'-','小米','备注',0,27,142,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(145,'77605c8e1debfe3e3fa924c23a10921c','products2','array',0,'','','产品详情2',0,27,132,3,1,1,2,'Jim',2,'Jim',4,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(146,'9ceea0a4180f9f2a3ef3f1728fa60882','productNo','string',0,'-','aaaa','产品id',0,27,145,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(147,'ed9061be7a63df541ade512f2235c88e','remark','string',0,'-','小米','备注',0,27,145,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(148,'ac5b31efb27c156c5a9ffc9974fa86b6','productDetailVO','object',0,'','','产品详情',0,27,145,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(149,'e590f30b98f1a3df9eb9196a170dc7f2','productNo','string',0,'-','aaaa','产品id',0,27,148,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(150,'a329de67e21b67540195f06224e30d3d','remark','string',0,'-','小米','备注',0,27,148,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(151,'7ed2b828ed63209954ef76b74fbdd15d','products3','array',0,'','','产品详情3',0,27,132,3,1,1,2,'Jim',2,'Jim',5,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(152,'335aa1d39325afcf300d3447d6d550d9','productNo','string',0,'-','aaaa','产品id',0,27,151,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(153,'912a57df158ee9fb98fa8cb0aee7025e','remark','string',0,'-','小米','备注',0,27,151,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(154,'1aba8c51efdb50af0a69dad5b8b676ca','productDetailVO','object',0,'','','产品详情',0,27,151,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(155,'4dd4f1c544ac437ed4119db5050dcda0','productNo','string',0,'-','aaaa','产品id',0,27,154,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(156,'f8712c097fa1d7555220161602e14ea6','remark','string',0,'-','小米','备注',0,27,154,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(157,'783167554ab8b18505c1cd357a1d735c','productArr','array',0,'','','产品详情arr',0,27,132,3,1,1,2,'Jim',2,'Jim',6,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(158,'06d10c6b7f5eb1bbc6997063969dfe54','productNo','string',0,'-','aaaa','产品id',0,27,157,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(159,'e51e5b0705a70b9f284ae222349d2845','remark','string',0,'-','小米','备注',0,27,157,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(160,'361db781672ecbbb9aee554536d6167f','productDetailVO','object',0,'','','产品详情',0,27,157,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(161,'5eaed8547bd3e93341bba30c9943f168','productNo','string',0,'-','aaaa','产品id',0,27,160,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(162,'87d7638b15d71216e4231a2e60679af0','remark','string',0,'-','小米','备注',0,27,160,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(163,'cb13d1285b6be3f1b3f67decd3013d2a','productNo','integer',1,'-','11','产品id',0,28,0,0,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(164,'eb54f27393dad80ad9f6fcf1ca3f345a','token','String',1,'-','asdfe','token',0,28,0,1,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(165,'9fbdb578a090adef2742b305e673a8ec','qid','string',1,'-','xx','查询id',0,28,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(166,'a9fc89056f306181cd8b0dd541a3fcbb','file','file',1,'-','','文件',0,28,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(167,'800accd0038c97f428c5259de89c5c5f','code','integer',0,'-','0','状态码，0：成功',0,28,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(168,'89527b4d92f55c290d87cbc843b32f2b','data','object',0,'-','','数据',0,28,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(169,'29ddea9191d77a38facf5ad51e743e7d','orderNo','string',0,'-','aaaa','订单id',0,29,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(170,'05a8322c9a6c2a161b3a3f967aedc851','remark','string',0,'-','订单','备注',0,29,0,2,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(171,'a2ef677b2a0f9de1049066b22789fc82','code','integer',0,'-','0','状态码，0：成功',0,29,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(172,'17b3538b64573f55d4f2dd3f7d9e340b','data','object',0,'','','数据',0,29,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(173,'2607d8f643981968c0181b2bd034bb64','orderNo','string',0,'-','aaaa','订单id',0,29,172,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(174,'9f48f962adf03de7547311670345368e','remark','string',0,'-','订单','备注',0,29,172,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(175,'635f25e5d792caaf985ab84537200f4d','orderNo','String',1,'-','xxx','订单id',0,30,0,0,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(176,'7a658cf66f3fe5d6c956ab9db0dcba00','orderNo','String',0,'-','xxx','订单id',0,30,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(177,'09565b835b400eb7ff300eaca52dcb7f','code','integer',0,'-','0','状态码，0：成功',0,30,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(178,'9a47544fd3e0d1d18550658e81601e4e','data','object',0,'','','数据',0,30,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(179,'12270736d940c7a6b12d9100fc04dccd','userId','number',0,'-','123','用户id',0,30,178,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(180,'1d00eba251f5f620901c87d4ca1432c6','orderNo','string',0,'-','xxx','订单号',0,30,178,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(181,'9dc25c45377fc5a9414d53162694c47b','payTime','date',0,'-','2021-05-24 19:59:51','订单id',0,30,178,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(182,'ffd132900589dcae6503c424943e9e4c','orderNo','String',0,'-','xxx','订单id',0,31,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(183,'ba80f33728800383642d5e2f681c008c','code','integer',0,'-','0','状态码，0：成功',0,31,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(184,'8be75c2c683e4cad7b094f42e5f5f9ce','data','object',0,'','','数据',0,31,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(185,'8e7cb6f00fd77e4b433517aeef7962b4','userId','number',0,'-','123','用户id',0,31,184,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(186,'94d8979c238fde4e19413ba5f982e44a','orderNo','string',0,'-','xxx','订单号',0,31,184,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(187,'7b95ebe4a4e3058f9b7b54beb27c11ee','payTime','date',0,'-','2021-05-24 19:59:51','订单id',0,31,184,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(188,'9013ae7e090a1d78a88a3add789a77f5','productNo','Integer',1,'-','11','产品id',0,32,0,0,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(189,'194fee94586186f23954a223cb7f3be7','token','String',1,'-','asdfe','token',0,32,0,1,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(190,'45417aba02cd8f62b95310b1977ed9c5','qid','String',0,'-','xx','查询id',0,32,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(191,'4e8ee7ee5db785e025df5da6a4be52d2','id','integer',0,'-','123','id',0,32,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(192,'1e98f88ae58383c9c38c903021d81ed1','orderNo','string',0,'-','aaaa','订单id',0,32,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(193,'99a8616ca96b3764796d25982a6410c6','code','integer',0,'-','0','状态码，0：成功',0,32,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(194,'b7bdde2bd2de256e47cbca48ff541ca0','data','object',0,'','','数据',0,32,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(195,'9e86472c86bf53f791f12eda4ef885bf','orderNo','string',0,'-','aaaa','订单id',0,32,194,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(196,'4360655b9cd479ffa3ee7e3c3e9effd2','remark','string',0,'-','订单','备注',0,32,194,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(197,'51d099a09028b5ffa86683f90a3e893c','orderDetail','object',0,'','','订单详情',0,32,194,3,1,1,2,'Jim',2,'Jim',2,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(198,'2e4421daada6bb561ea9d4ce17293176','userId','number',0,'-','123','用户id',0,32,197,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(199,'d8154aa3347a09292ac7276973f1a84c','orderNo','string',0,'-','xxx','订单号',0,32,197,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(200,'a022cbc10e9807d285ca0f81b5a04326','payTime','date',0,'-','2021-05-24 19:59:51','订单id',0,32,197,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(201,'f5cb61d2604178f894e45594a425ce97','products','array',0,'','','产品详情',0,32,194,3,1,1,2,'Jim',2,'Jim',3,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(202,'8b2b379b755f0e9e776331c26cc629c1','productNo','string',0,'-','aaaa','产品id',0,32,201,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(203,'a80b6d57b8ebd715e591fb3495ccc1ff','remark','string',0,'-','小米','备注',0,32,201,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(204,'392b4c1999136e82af3f8df461200fb2','productDetailVO','object',0,'','','产品详情',0,32,201,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(205,'87fdd7c17f5ab1f36dedb605cb8bcfe2','productNo','string',0,'-','aaaa','产品id',0,32,204,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(206,'a4e84a92dffb419991412907087fde65','remark','string',0,'-','小米','备注',0,32,204,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(207,'fb4f0382a10404bb580496754f9daa02','products2','array',0,'','','产品详情2',0,32,194,3,1,1,2,'Jim',2,'Jim',4,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(208,'a9a1ffc1c291254126313236b89f2e73','productNo','string',0,'-','aaaa','产品id',0,32,207,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(209,'08325c86d943776d490446808c8856fa','remark','string',0,'-','小米','备注',0,32,207,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(210,'959abba7ee8c1591773f029ed156276e','productDetailVO','object',0,'','','产品详情',0,32,207,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(211,'3eff17b737d7ec788d832c2386bcdaf2','productNo','string',0,'-','aaaa','产品id',0,32,210,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(212,'da91f958dd723257785a8e4f239d7512','remark','string',0,'-','小米','备注',0,32,210,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(213,'cc77b4577154bb7a3d11be3c9d40d9c4','products3','array',0,'','','产品详情3',0,32,194,3,1,1,2,'Jim',2,'Jim',5,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(214,'50f92b6dff998eb1ea6f04eb2e049d2a','productNo','string',0,'-','aaaa','产品id',0,32,213,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(215,'ec1d74c13715b6850755e1ca09242013','remark','string',0,'-','小米','备注',0,32,213,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(216,'171fd4c155b34ff25b3d5dd01624edfa','productDetailVO','object',0,'','','产品详情',0,32,213,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(217,'3e4959ab4fddddf8dca2bd6f64829fee','productNo','string',0,'-','aaaa','产品id',0,32,216,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(218,'07732a51890afd0f7fa49fdad82490e2','remark','string',0,'-','小米','备注',0,32,216,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(219,'e98334be70e2db4010aa2f9acd4446c5','productArr','array',0,'','','产品详情arr',0,32,194,3,1,1,2,'Jim',2,'Jim',6,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(220,'f2d59b634f94eebb1d1d3e6004e6e7f7','productNo','string',0,'-','aaaa','产品id',0,32,219,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(221,'548d553e2ac6ce7d4371fa00e95fd165','remark','string',0,'-','小米','备注',0,32,219,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(222,'ecd05b58c4a684520fc558513aa845a3','productDetailVO','object',0,'','','产品详情',0,32,219,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(223,'0bb0d90ab68cb1f29481ae97f85a84ab','productNo','string',0,'-','aaaa','产品id',0,32,222,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(224,'46c293af244b047b340bdb4ef9710a3a','remark','string',0,'-','小米','备注',0,32,222,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(225,'ffa37f95b949f54b48d68e5737860d33','productNo','Integer',1,'-','','',0,33,0,0,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(226,'e512fefcd6798cca4a6c61f3387b1828','token','String',1,'-','','',0,33,0,1,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(227,'cb997b29362e102257401aeb1ce1736d','qid','String',0,'-','','',0,33,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(228,'470811a0ef439cff787fefa1928f1953','productNo','Integer',0,'-','','',0,33,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(229,'4ac70e1396bbca9a3135f2f261bb40b3','token','String',0,'-','','',0,33,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(230,'6eaa61d80915cd5e39663663e3c46cf8','id','integer',1,'-','1','查询id',0,33,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(231,'1a8643766058a62d720a4f31958446c3','orderNo','integer',0,'-','xxx','订单id',0,33,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(232,'1fd1770abb5c6dbaec548c4ce64a4749','code','integer',0,'-','0','状态码，0：成功',0,33,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(233,'d1b9be6652142432b2b00c3dd210eecc','data','array',0,'','','数据',0,33,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(234,'2a7093b3e7a9b0a05d9bf4e79dc4a206','userId','number',0,'-','123','用户id',0,33,233,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(235,'1cb84c7c0ed96d582d3a9d9116dee89e','orderNo','string',0,'-','xxx','订单号',0,33,233,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(236,'bffa32e265bb443213a91ef3ada21305','payTime','date',0,'-','2021-05-24 19:59:51','订单id',0,33,233,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(237,'4bad03085b444504c796679865ca8108','code','integer',0,'-','0','状态码，0：成功',0,35,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(238,'cfef20e6813836873cf506952879c382','data','object',0,'','','数据',0,35,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(239,'db18308c17fbf630b57d0303a7a9af03','id','integer',0,'-','','',0,35,238,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(240,'126f895f424fe90eefc86d3b9a0e8561','name','string',0,'-','','名称',0,35,238,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(241,'f4413905452fe4821eeb52872604f435','parentId','integer',0,'-','','父id',0,35,238,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(242,'5d622869a4ee2b93129b991904662273','children','array',0,'','','子节点',0,35,238,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(243,'404c22450e9a8d80f55964d6acd1f9bb','id','integer',0,'-','','',0,35,242,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(244,'253240af265774bbf2f25bc84e264cad','name','string',0,'-','','名称',0,35,242,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(245,'470885a96535f07de1af8c682b3119d5','parentId','integer',0,'-','','父id',0,35,242,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(246,'25c8203117d1147a8694fc87a21bdd58','children','array',0,'-','','子节点',0,35,242,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(247,'748c4ab34e286c9f56a42820772f26b8','productNo','Integer',1,'-','123','产品id',0,36,0,0,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(248,'339733d17bd4a7bd0ef50e9c9195b559','productNo','Integer',0,'-','123','产品id',0,36,0,5,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(249,'036bd027d059a5df1a68da8564a2fbe3','productNo','string',0,'-','aaaa','产品id',0,36,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(250,'4f990edab98fe3a3f9a99cc89350a5ac','remark','string',0,'-','小米','备注',0,36,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(251,'894ae45061adcdd417619fb633575b4b','productDetailVO','object',0,'','','产品详情',0,36,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(252,'fdd2db7c376976b31cfff04798d7a52f','productNo','string',0,'-','aaaa','产品id',0,36,251,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(253,'29883c730cf9d36bba9758d5bb52fa3e','remark','string',0,'-','小米','备注',0,36,251,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(254,'b04de9854965a39a2f3268e3b9d4c0d1','100001','String',0,'-','','id错误',0,36,0,4,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(255,'788b90ef067d5c8f977fcf98606fc073','100002','String',0,'-','','错误描述2',0,36,0,4,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(256,'32bf6eb90790a489eb16c6ead71549af','100003','String',0,'-','','错误描述3',0,36,0,4,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(257,'20fa7cf58fd296569d59ccdfe2708177','file','file',1,'-','','产品模板文件',0,37,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(258,'f7b2209cabe7d77128a20f3feab79e5a','productNo','String',1,'-','111','产品id',0,37,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(259,'ed4a68feeca8bbc3116be7d3c02238f2','code','integer',0,'-','0','状态码，0：成功',0,37,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(260,'993aac43e5e977be867b163404057717','data','object',0,'-','','数据',0,37,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(261,'fb948d90f6987762ba09bd4b59ad11ca','file','file',0,'-','','产品模板文件',0,38,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(262,'8b5e84f261c5707090f05806a7d10982','files','file[]',0,'-','','产品模板文件Array',0,38,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(263,'4c96dba27235f710168a893889ab7874','fileList','file[]',0,'-','','产品模板文件List',0,38,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(264,'3d8d331903744306c6d76a0c150f515b','productNo','string',1,'-','111','产品id',0,38,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(265,'3b3fb4ae48177d3d7c76e9319393635a','code','integer',0,'-','0','状态码，0：成功',0,38,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(266,'82dd57c7dee4618f97068bf271cdb2f8','data','object',0,'-','','数据',0,38,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(267,'166e20da9e17c235d9e9e25c25f43640','files','file[]',1,'-','','产品模板文件',0,39,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(268,'39a5f028ec63030df158e4aeff9da4ed','productNo','String',1,'-','111','产品id',0,39,0,2,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(269,'db930770f6a9ec313407f8f4aa7e0448','code','integer',0,'-','0','状态码，0：成功',0,39,0,3,1,1,2,'Jim',2,'Jim',0,0,'2021-06-08 13:54:23','2021-06-08 13:54:23'),
	(270,'df5ac720266566ed4e6e66df96330af8','data','object',0,'-','','数据',0,39,0,3,1,1,2,'Jim',2,'Jim',1,0,'2021-06-08 13:54:23','2021-06-08 13:54:23');
...
INSERT INTO `module_config` (`id`, `module_id`, `type`, `config_key`, `config_value`, `extend_id`, `description`, `is_deleted`, `gmt_create`, `gmt_modified`) VALUES
	...
	(3,3,2,'test','http://127.0.0.1:8088',0,'',0,'2021-06-08 13:54:23','2021-06-08 13:54:23');
